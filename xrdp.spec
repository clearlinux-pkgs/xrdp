...
Source0  : https://github.com/neutrinolabs/xrdp/releases/download/v0.9.17/xrdp-0.9.17.tar.gz
Source1  : https://github.com/neutrinolabs/xrdp/releases/download/v0.9.17/xrdp-0.9.17.tar.gz.asc
...
%prep
%setup -q -n xrdp-0.9.17
cd %{_builddir}/xrdp-0.9.17
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630631283
...
cp %{_builddir}/xrdp-0.9.17/COPYING %{buildroot}/usr/share/package-licenses/xrdp/490afe7aa564c6be23045021284706e4710336f6
%make_install
