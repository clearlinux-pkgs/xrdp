...
Version  : 0.9.3.1
Release  : 10
URL      : https://github.com/neutrinolabs/xrdp/archive/v0.9.3.1.tar.gz
Source0  : https://github.com/neutrinolabs/xrdp/archive/v0.9.3.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1506365350
