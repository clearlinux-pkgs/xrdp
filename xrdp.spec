...
Source0  : https://github.com/neutrinolabs/xrdp/releases/download/v0.9.25/xrdp-0.9.25.tar.gz
Source1  : https://github.com/neutrinolabs/xrdp/releases/download/v0.9.25/xrdp-0.9.25.tar.gz.asc
...
%prep
%setup -q -n xrdp-0.9.25
cd %{_builddir}/xrdp-0.9.25
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a xrdp-0.9.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710181591
